...
grep 'WAN_LOCAL' messages.log | head -1 | promtail --stdin --dry-run --inspect --config.file=/etc/promtail/promtail-debug.yaml -server.http-listen-port 9081 --log.level debug
